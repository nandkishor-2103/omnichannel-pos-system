...
export default function EmployeeTable() {
  const [selectedEmployee, setSelectedEmployee] = useState<StoreEmployeeFormValues>();
  ...
  const filteredEmployees =
    user?.role === "ROLE_STORE_MANAGER"
      ? employees.filter((employee) => employee.role !== "ROLE_STORE_ADMIN")
      : employees;
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                          {employee.store.brand ?? "No store Assigned"}
                        </p>
                      </div>
                    </div>
                  </TableCell>
